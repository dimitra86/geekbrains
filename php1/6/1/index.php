...
{   
  ...
  return; 
    ...
    {
         echo "Файл не загружен. Размер файла превышает 2 мегабайт.";
    }
    else
    {   
...
<body>  
  ...
  <input type="submit" value="Загрузить файл!" />   
    ...
    foreach ($papka as $name_image)
    {
        ...
        {
            echo("<a href=image/".$name_image." target=_blank><img src=image/".$name_image." height=150 width=200 border=1 hspace=10></a>");
        //echo $name_image;
        }
    } ?>
